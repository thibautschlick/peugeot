...
<div class="colonne_100pc_contenu">
		...
		// RIGHT MENU
		echo '<h3>';
		echo $edit_liste_elements_side_right;		
		echo '<br/><br/></h3>';
		foreach ($ELEMENTS_MENU_RIGHT as $menu_groupe => $contenu_groupe)
		{
			$affiche_menu = true;
			...
			?>
				...
				<li>
					...
					?>					
					<?php				
					$affichage = affiche_texte_dyn('side_right_menu_'.$menu_groupe);					
					echo '';
					echo '<b>';
					echo $affichage;									
					echo '</b>';
								...
								//{
									...
									<li style="position:relative;left: 5%;padding-left:0px;">						
											...
											<?php
												...
												echo affiche_texte_dyn('side_right_menu_'.$key_ss_menu); // exemple "menu_le_groupe", "menu_message_du_president" // false pour sans btn pour menu, car sinon lien dans lien
												echo '<br/>';
											?>
									</li>					
									<?php
